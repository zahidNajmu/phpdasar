...
<head>
    ...
    <body>
        ...
        <svg id="wave" style="transform:rotate(0deg); transition: 0.3s" viewBox="0 0 1440 490" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0"><stop stop-color="rgba(243, 106, 62, 1)" offset="0%"></stop><stop stop-color="rgba(255, 179, 11, 1)" offset="100%"></stop></linearGradient>
            </defs>
        ...
        <section>
            ...
            <?php if( $i == $halamanAktif ) : ?>
                <a href="?halaman=<?= $i; ?>" class="halaman-aktif" style="transform: scale(1.2); color: rgb(3, 179, 248);" ><?= $i; ?></a>
            <?php else : ?>
